...
[] spawn {
    ...
    _messages = [
        "Strona Serwera:<br/>
        <t color='#44CBFF' size='1.5'>www.World-life.xaa.pl</t><br/><br/>
        TeamSpeak:<br/>
        <t color='#44CBFF' size='1.5'>5.196.210.216:10077</t><br/><br/>
        Restarty Serwera:<br/>
    ...
    while {true} do {
        ...
        hint parseText format["<t color='#ffffff' size='2'>World Life</t><t color='#c45454' size='2'>Altis</t><br/><br/><img shadown='false' size='6' image='textures\logo.jpg'/><br/><br/>%1", _message];
        sleep _refreshTime;
        if (_i == (_count - 1)) then {
            _i = 0;
        } else {
